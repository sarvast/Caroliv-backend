...
export async function logWorkout(
    ...
    try {
        ...
        context.log(`Workout logged for user: ${payload.email}, calories: ${body.calories}`);
        ...
        context.error('Log workout error:', error);
        return {
            status: 500,
            jsonBody: { success: false, message: 'Failed to log workout' },
        };
    }
}
